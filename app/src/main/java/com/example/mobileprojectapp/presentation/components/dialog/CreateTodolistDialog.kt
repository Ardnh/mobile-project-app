...
fun AddTodolistDialog(
    ...
    Dialog(
        ...
        var todolistNameState by remember { mutableStateOf("") }
        ...
        Card(
            ...
            Column(
                ...
                CustomTextField(
                    value = todolistNameState,
                    onValueChange = { it -> todolistNameState = it },
                ...
                Row(
                    ...
                    TextButton(
                        onClick = { onAddNewTodolist(todolistNameState) },
                        enabled = todolistNameState.isNotBlank(),
                        contentPadding = PaddingValues(horizontal = 20.dp, vertical = 10.dp),
                        modifier = Modifier
                            .width(70.dp)
                    ) {
